...
def successor_fn(state):  # Lookup list of successor states
    if state in [('W', 'W', 'E', 'E'), ('E', 'E', 'W', 'W'), ('W', 'E', 'E', 'W'), ('E', 'W', 'W', 'E')]:
        return []
...
STATE_SPACE = {('A', 'Clean', 'Clean'): [('A', 'Clean', 'Clean'), ('B', 'Clean', 'Clean')],
...
STATE_SPACE = {('W', 'W', 'W', 'W'): [('E', 'E', 'W', 'W'), ('E', 'W', 'E', 'W'), ('E', 'W', 'W', 'E')],
